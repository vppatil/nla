...
# User input:
#nhd = arcpy.GetParameterAsText(0) # This is a NHD 24k Subregion file geodatabase.
nhd = glob.glob('*.gdb')
nhd = nhd[0]
arcpy.env.workspace = nhd
#outfolder = arcpy.GetParameterAsText(1) # Where you want to write the output from this tool.

outfolder = 'out' #create and use the "out" directory
