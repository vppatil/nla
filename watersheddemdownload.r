library(devtools)
 install_github(repo='rGDP',username='jread-usgs',ref='master')
library(rGDP)
...
# next, download and parse rG

download.link<-checkProcess(rGDP)$URL
download.file(download.link,'usgsmap1')
