...
par(mfrow=c(2,2))
plot(log(avg_daphnia_den_bysite$avgDen), log(avg_daphnia_den_bysite$CHLA), xlab = "Daphnia Density", ylab = "Chl")
plot(log(avg_daphnia_den_bysite$avgDen), log(avg_daphnia_den_bysite$SECCHI), xlab = "Daphnia Density", ylab = "Secchi")
plot(log(avg_daphnia_den_bysite$avgDen), log(avg_daphnia_den_bysite$AREAHA), xlab = "Daphnia Density", ylab = "Lake Area")
plot(log(avg_daphnia_den_bysite$avgDen), log(avg_daphnia_den_bysite$DOC), xlab = "Daphnia Density", ylab = "DOC")
dev.off()

for (i in 1:18) {
  
plot(log(avg_daphnia_den_bysite$avgDen[avg_daphnia_den_bysite$HUC_2 == i]), log(avg_daphnia_den_bysite$CHLA[avg_daphnia_den_bysite$HUC_2 == i]), xlab = "Daphnia Density", ylab = "Chl", main = i)
